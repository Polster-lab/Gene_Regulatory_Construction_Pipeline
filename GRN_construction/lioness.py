...
class Lioness(Panda):
    ...
    def __init__(
        ...
        subset_numbers=None,
        subset_names=None,
        save_dir="/cephyr/NOBACKUP/groups/naiss2023-23-453/GRN_output_2/",
        save_fmt="csv",
        output="network",
        alpha=0.1,
        save_single = True,
        export_filename = '/cephyr/NOBACKUP/groups/naiss2023-23-453/GRN_output_2/lioness_table.csv',
        ignore_final=False, 
    ):
    ...
    def export_lioness_table(self, output_filename="/cephyr/NOBACKUP/groups/naiss2023-23-453/GRN_output/lioness_table.csv", header=False, output = 'network'):
        """ 
